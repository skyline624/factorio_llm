...
## Charbon et pierre extraits par les machines

La production générale prépare et réutilise désormais une foreuse à combustible déversant dans un coffre. Dans le monde de développement normal, le C# a atteint 50 charbons nets après un seul charbon miné à la main pour l'amorçage, puis 50 pierres provenant intégralement de la nouvelle foreuse. La fabrication de chaque foreuse a nécessité cinq pierres d'amorçage, et le fer provenait des machines existantes. Les [preuves détaillées](raw-extraction.md) comptabilisent séparément les constructions, le bois, les chargements et les consommations, et décrivent les interruptions corrigées sans restauration des progrès.

Les observations et reçus natifs confirment les stocks, les déposes, les capacités et le combustible encore en combustion. Le dernier contrôle constate 50 pierres et 38 charbons portés ; le monde est sauvegardé au tick 1414650 et son serveur arrêté. Les 415 tests hors ligne passent, avec un test cloud optionnel ignoré ; la compilation Release ne signale aucun avertissement ni erreur. Ces objectifs C# exécutés en headless ne remplacent pas les trois campagnes finales : zéro fusée et zéro campagne qualifiée.
