...
Lors de la qualification ultérieure du [laboratoire](laboratory-research.md), le même réseau a fourni environ 1 006,667 J par tick, soit 60,4 kW, au tick 732 394. La chaudière avait reçu quatre nouvelles unités de bois récoltées normalement. La recherche a terminé après consommation de dix packs. Cette mesure ajoute une preuve sous charge de laboratoire ; elle ne mesure pas la capacité maximale du réseau.
