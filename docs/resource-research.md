...
La reprise de la partie normale a bien écarté les trois gisements protégés, puis choisi des étapes d'exploration vers `(76,-188)` et `(68,-212)`. Elle n'a cependant pas atteint un autre site exploitable : le personnage 1683 est mort au tick 9526682 pendant le combat, puis trois tentatives de récupération ont subi le même sort aux ticks 9531772, 9536881 et 9541710. Le contrôleur a été interrompu pour arrêter cette répétition. Le checkpoint 9549042 conserve le monde, les pertes et l'incarnation 11 ; aucun pétrole normal n'est prouvé et aucun progrès n'a été restauré. Les limites de survie et de récupération sont donc le prochain obstacle réel, distinct du choix des gisements corrigé.
